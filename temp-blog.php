        ...
        <div class="grid grid-cols-1 gap-5 lg:grid-cols-[minmax(0,1fr)_310px]">
            ...
            <div class="space-y-5">
                ...
                if ($query->have_posts()):
                    ...
                    while ($query->have_posts()):
                        ...
                        <!-- BLOG CARD -->
                        <article
                            class="rounded-[22px] border border-[#e8e8e8] bg-white p-3 shadow-sm transition duration-300 hover:shadow-md sm:p-4">
                            ...
                            <div class="relative h-[190px] overflow-hidden rounded-[16px] sm:h-[230px] md:h-[265px]">
                                ...
                                <a href="<?php the_permalink(); ?>">
                                    ...
                                    <?php else: ?>
                                        ...
                                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/blog-image.webp'); ?>"
                                            alt="<?php echo esc_attr(get_the_title()); ?>" class="h-full w-full object-cover">
                                ...
                                <!-- Category Badge -->
                                <span
                                    class="absolute left-3 top-3 rounded-[9px] border border-primary bg-white/95 px-3 py-1.5 text-[10px]  text-[#4169e1] shadow-sm sm:text-[11px]">
                            ...
                            <div class="pt-3 sm:pt-4">
                                ...
                                <!-- Title -->
                                <h2
                                    class="mb-2 text-[16px] font-bold leading-[1.3] tracking-[-0.4px] text-coff_black sm:text-[28px]">
                                ...
                                <!-- Excerpt -->
                                <p
                                    class="mb-4 overflow-hidden text-ellipsis whitespace-nowrap text-[13px] leading-5  sm:text-[15px] text-secondaryLight">
                                ...
                                <div class="flex items-center justify-between gap-4">
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <div class="flex items-center gap-2">
                                            <span class="text-[10px]  text-coff_black sm:text-[11px]">
                                                <?php the_author(); ?>
                                            </span>
                                            <!-- Blue Dot -->
                                            <span class="h-[5px] w-[5px] rounded-full bg-primary"></span>
                                            <!-- Date -->
                                            <span class="text-[9px] text-secondaryLight sm:text-[10px]">
                                    ...
                                    <a href="<?php the_permalink(); ?>"
                                        ...
                                        class="flex h-7 w-7 items-center justify-center text-[18px]  text-secondaryLight transition hover:text-primary">
                                        →
                                    </a>
                                </div>
                            </div>
            ...
            <aside class="space-y-5">
                ...
                <div class="rounded-[18px] bg-white p-4 shadow-sm sm:p-5">
                    <h2 class="mb-4 text-[15px]   text-coff_black">
                    ...
                    <form method="get" action="<?php echo esc_url(home_url('/')); ?>">
                        <div class="relative">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                                ...
                                class="absolute left-4 top-1/2 h-4 w-4 -translate-y-1/2 text-secondaryLight">
                                <circle cx="11" cy="11" r="7"></circle>
                                <path d="m20 20-3.5-3.5"></path>
                            </svg>
                            <input type="search" name="s" value="<?php echo esc_attr(get_search_query()); ?>"
                                placeholder="Search A Blog Content"
                                class="h-[46px] w-full rounded-[12px] border border-primary bg-[#fafafa] pl-10 pr-4 text-[11px] text-coff_black outline-none transition focus:ring-2 focus:ring-[#4169e1]/20">
                        </div>
                        <button type="submit"
                        ...
                        if ($latest_query->have_posts()):
                            while ($latest_query->have_posts()):
                                ...
                                <a href="<?php the_permalink(); ?>"
                                    ...
                                    <!-- Post Title -->
                                    <h3 class="text-[13px]   leading-[1.5] text-coff_black">
                                        <?php
                                        echo esc_html(
                                            wp_trim_words(
                                                get_the_title(),
