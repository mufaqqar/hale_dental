<section class="w-full bg-[#f5f5f5] py-12">
    ...
    <div class="container mx-auto px-4 grid md:grid-cols-3 grid-cols-1 gap-5">
        <div class="relative w-full h-[300px] sm:h-[300px] lg:h-[350px] overflow-hidden rounded-[30px] bg-[#d9dde0]">
            <!-- Image -->
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/image-435-1.webp"
                alt="Same-Day Dentistry" class="absolute inset-0 w-full h-full object-cover object-center">

            <!-- Glass Card -->
            <div
                class="absolute left-[6%] right-[6%] bottom-[8%] min-h-[240px] lg:min-h-[288px] flex flex-col items-center justify-center rounded-[27px] border border-white/50 bg-white/[0.62] backdrop-blur-[14px] shadow-[0_12px_35px_rgba(0,0,0,0.18)] px-5 py-7 md:px-10">

                <h3 class="text-lg sm:text-2xl text-coff_black text-center">
                    Same-Day Dentistry
                </h3>

                <p class="text-base text-secondaryLight text-center">
